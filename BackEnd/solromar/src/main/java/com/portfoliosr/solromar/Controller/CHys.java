...
import com.portfoliosr.solromar.Dto.dtoHys;
import com.portfoliosr.solromar.Entity.hys;
import com.portfoliosr.solromar.Security.Controller.Mensaje;
import com.portfoliosr.solromar.Service.Shys;
...
public class CHys {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHys dtohys) {
        ...
        hys hYs = new hys(dtohys.getNombre(), dtohys.getDescripcion());
        shys.save(hYs);
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoHys dtohys) {
        ...
        hYs.setDescripcion(dtohys.getDescripcion());
