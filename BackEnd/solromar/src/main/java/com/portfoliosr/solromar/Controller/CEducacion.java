...
import com.portfoliosr.solromar.Dto.dtoEducacion;
import com.portfoliosr.solromar.Entity.Educacion;
import com.portfoliosr.solromar.Security.Controller.Mensaje;
import com.portfoliosr.solromar.Service.SEducacion;
...
@PostMapping("/crear")
    public ResponseEntity<?> create (@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion= new Educacion(dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getPeriodoE());
